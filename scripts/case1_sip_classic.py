...
Examples:
  ...
  python case1_sip_classic.py --algorithms KNN --datasets Iris --seeds 42
    ...
    parser.add_argument(
        "--log-dir",
        default="logs/case1",
        help="Directory for case1 execution logs (default: logs/case1)",
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
    ...
    log_file = configure_case_file_logger(logger, args.log_dir, "case1")
    logger.info("Case1 log file: %s", log_file)
