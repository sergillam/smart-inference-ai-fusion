...
class RidgeModel(BaseModel):
    def predict_proba(self, X):
        ...
        Uses the decision_function and applies softmax to approximate class probabilities.
        This enables compatibility with metrics and inference steps that require probabilities.

        Args:
            X (array-like): Input features.

        Returns:
            np.ndarray: Array of shape (n_samples, n_classes) with pseudo-probabilities.
        """
