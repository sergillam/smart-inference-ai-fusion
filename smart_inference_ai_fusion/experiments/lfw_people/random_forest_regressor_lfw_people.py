"""Experiment script for RandomForestRegressorModel on the LFW People dataset."""
...
def run():
    """Run RandomForestRegressorModel experiments on the LFW People dataset.

    Executes both baseline and inference experiments using standard configurations.
    """
    return run_experiment_by_model(
        RandomForestRegressorModel, dataset_name=SklearnDatasetName.LFW_PEOPLE
    )
