"""Experiment script for RidgeModel on the Lfw People dataset."""
...
def run():
    """Run RidgeModel experiments on the Lfw People dataset.

    Executes both baseline and inference experiments using standard configurations.
    """
    return run_experiment_by_model(RidgeModel, dataset_name=SklearnDatasetName.LFW_PEOPLE)
