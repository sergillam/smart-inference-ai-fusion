"""Experiment script for FastICAModel on the Lfw People dataset."""
...
def run():
    """Run FastICAModel experiments on the Lfw People dataset.

    Executes both baseline and inference experiments using standard configurations.
    """
    return run_experiment_by_model(FastICAModel, dataset_name=SklearnDatasetName.LFW_PEOPLE)
