"""Experiment script for SpectralClusteringModel on the LFW People dataset."""
...
def run():
    """Run SpectralClusteringModel experiments on the LFW People dataset.

    Executes both baseline and inference experiments using standard configurations.
    """
    return run_experiment_by_model(
        SpectralClusteringModel, dataset_name=SklearnDatasetName.LFW_PEOPLE
    )
