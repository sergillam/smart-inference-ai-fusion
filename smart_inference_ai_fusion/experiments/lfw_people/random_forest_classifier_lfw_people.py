"""Experiment script for RandomForestClassifierModel on the Lfw People dataset."""
...
def run():
    """Run RandomForestClassifierModel experiments on the Lfw People dataset.

    Executes both baseline and inference experiments using standard configurations.
    """
    return run_experiment_by_model(
        RandomForestClassifierModel, dataset_name=SklearnDatasetName.LFW_PEOPLE
    )
