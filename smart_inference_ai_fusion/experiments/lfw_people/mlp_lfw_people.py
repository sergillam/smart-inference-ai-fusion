"""Experiment script for MLPModel on the Lfw People dataset."""
...
def run():
    """Run MLPModel experiments on the Lfw People dataset.

    Executes both baseline and inference experiments using standard configurations.
    """
    return run_experiment_by_model(MLPModel, dataset_name=SklearnDatasetName.LFW_PEOPLE)
