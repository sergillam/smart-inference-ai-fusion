"""Experiment script for AgglomerativeClusteringModel on the 20 Newsgroups dataset."""
...
def run():
    """Run AgglomerativeClusteringModel experiments on the 20 Newsgroups dataset.

    Executes both baseline and inference experiments using standard configurations.
    """
    return run_experiment_by_model(
        AgglomerativeClusteringModel, dataset_name=SklearnDatasetName.NEWSGROUPS_20
    )
