"""Experiment script for SpectralClusteringModel on the 20 Newsgroups dataset."""
...
def run():
    """Run SpectralClusteringModel experiments on the 20 Newsgroups dataset.

    Executes both baseline and inference experiments using standard configurations.
    """
    return run_experiment_by_model(
        SpectralClusteringModel, dataset_name=SklearnDatasetName.NEWSGROUPS_20
    )
