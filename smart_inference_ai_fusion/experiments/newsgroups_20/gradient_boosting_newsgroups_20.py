"""Experiment script for GradientBoostingModel on the 20 Newsgroups dataset."""
...
def run():
    """Run GradientBoostingModel experiments on the 20 Newsgroups dataset.

    Executes both baseline and inference experiments using standard configurations.
    """
    return run_experiment_by_model(
        GradientBoostingModel, dataset_name=SklearnDatasetName.NEWSGROUPS_20
    )
