"""Experiment script for RidgeModel on the 20 Newsgroups dataset."""
...
def run():
    """Run RidgeModel experiments on the 20 Newsgroups dataset.

    Executes both baseline and inference experiments using standard configurations.
    """
    return run_experiment_by_model(RidgeModel, dataset_name=SklearnDatasetName.NEWSGROUPS_20)
