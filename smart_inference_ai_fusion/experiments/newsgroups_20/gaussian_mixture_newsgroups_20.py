"""Experiment script for GaussianMixtureModel on the 20 Newsgroups dataset."""
...
def run():
    """Run GaussianMixtureModel experiments on the 20 Newsgroups dataset.

    Executes both baseline and inference experiments using standard configurations.
    """
    return run_experiment_by_model(
        GaussianMixtureModel, dataset_name=SklearnDatasetName.NEWSGROUPS_20
    )
