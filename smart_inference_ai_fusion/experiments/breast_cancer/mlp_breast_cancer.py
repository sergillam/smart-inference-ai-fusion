"""Experiment script for MLPModel on the Breast Cancer dataset."""
...
def run():
    """Run MLPModel experiments on the Breast Cancer dataset.

    Executes both baseline and inference experiments using standard configurations.
    """
    return run_experiment_by_model(MLPModel, dataset_name=SklearnDatasetName.BREAST_CANCER)
