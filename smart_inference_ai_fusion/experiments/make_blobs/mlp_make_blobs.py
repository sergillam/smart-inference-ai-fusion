"""MLP experiment for Make Blobs dataset."""
...
def run():
    """Run Make Blobs dataset MLP experiment."""
    return run_experiment_by_model(MLPModel, dataset_name=SklearnDatasetName.MAKE_BLOBS)
