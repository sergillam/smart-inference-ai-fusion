"""Decision Tree experiment for Make Blobs dataset."""
...
def run():
    """Run Make Blobs dataset decision tree experiment."""
    return run_experiment_by_model(DecisionTreeModel, dataset_name=SklearnDatasetName.MAKE_BLOBS)
