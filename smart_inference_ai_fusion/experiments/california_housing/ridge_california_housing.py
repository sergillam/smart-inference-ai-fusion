"""Experiment script for RidgeModel on the California Housing dataset."""
...
def run():
    """Run RidgeModel experiments on the California Housing dataset.

    Executes both baseline and inference experiments using standard configurations.
    """
    return run_experiment_by_model(RidgeModel, dataset_name=SklearnDatasetName.CALIFORNIA_HOUSING)
