"""Experiment script for MiniBatchKMeansModel on the California Housing dataset."""
...
def run():
    """Run MiniBatchKMeansModel experiments on the California Housing dataset.

    Executes both baseline and inference experiments using standard configurations.
    """
    return run_experiment_by_model(
        MiniBatchKMeansModel, dataset_name=SklearnDatasetName.CALIFORNIA_HOUSING
    )
