"""Experiment script for GradientBoostingModel on the California Housing dataset."""
...
def run():
    """Run GradientBoostingModel experiments on the California Housing dataset.

    Executes both baseline and inference experiments using standard configurations.
    """
    return run_experiment_by_model(
        GradientBoostingModel, dataset_name=SklearnDatasetName.CALIFORNIA_HOUSING
    )
