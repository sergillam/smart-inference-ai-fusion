"""Experiment script for GaussianMixtureModel on the California Housing dataset."""
...
def run():
    """Run GaussianMixtureModel experiments on the California Housing dataset.

    Executes both baseline and inference experiments using standard configurations.
    """
    return run_experiment_by_model(
        GaussianMixtureModel, dataset_name=SklearnDatasetName.CALIFORNIA_HOUSING
    )
