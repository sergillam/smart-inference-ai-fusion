"""Experiment script for LogisticRegressionModel on the Wine dataset."""
...
def run():
    """Run LogisticRegressionModel experiments on the Wine dataset.

    Executes both baseline and inference experiments using standard configurations.
    """
    return run_experiment_by_model(LogisticRegressionModel, dataset_name=SklearnDatasetName.WINE)
