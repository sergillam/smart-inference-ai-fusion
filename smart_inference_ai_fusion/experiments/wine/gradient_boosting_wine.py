"""Experiment script for GradientBoostingModel on the Wine dataset."""
...
def run():
    """Run GradientBoostingModel experiments on the Wine dataset.

    Executes both baseline and inference experiments using standard configurations.
    """
    return run_experiment_by_model(GradientBoostingModel, dataset_name=SklearnDatasetName.WINE)
