"""Experiment script for RandomForestRegressorModel on the Make Moons dataset."""
...
def run():
    """Run RandomForestRegressorModel experiments on the Make Moons dataset.

    Executes both baseline and inference experiments using standard configurations.
    """
    return run_experiment_by_model(
        RandomForestRegressorModel, dataset_name=SklearnDatasetName.MAKE_MOONS
    )
