"""Experiment script for FastICAModel on the Make Moons dataset."""
...
def run():
    """Run FastICAModel experiments on the Make Moons dataset.

    Executes both baseline and inference experiments using standard configurations.
    """
    return run_experiment_by_model(FastICAModel, dataset_name=SklearnDatasetName.MAKE_MOONS)
