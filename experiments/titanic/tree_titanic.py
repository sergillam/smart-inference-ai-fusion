...
from utils.types import DatasetSourceType, CSVDatasetName, DatasetNoiseConfig
...
def run_tree_without_inference():
    ...
    dataset = DatasetFactory.create(
        ...
        file_path=CSVDatasetName.TITANIC,
...
def run_tree_with_inference():
    ...
    report_data(metrics, mode=ReportMode.PRINT)
    report_data(param_log, mode=ReportMode.JSON, file_path='results/tree_param_log-titanic.json')
